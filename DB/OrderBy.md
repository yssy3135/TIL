...
- 정렬관련 몇건의 레코드나 정렬 처리를 수행했는지, 소트 버퍼간의 병합 작업(멀티 머지)는 몇번이나 발생했는지 등을 확인할 수 있다.

![Pasted image 20230926234507.png](image%2FOrderBy%20Image%2FPasted%20image%2020230926234507.png)
...
**의미는?**
- 풀 테이블 스캔을 : 1번 (Sort_scan)
- 단위 정렬 작업의 결과 : 13번 (Sort_merge_passes)
- 전체 정렬된 레코드 건수는 300.24건 (Sort_rows)
